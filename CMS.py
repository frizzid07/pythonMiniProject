...
#-------------------creating labels-----------------------
lb1Info=Label(Tops,font=('arial',50,'bold'),text="CAFE MANAGEMENT SYSTEM",bd=10)
...
#-----------------------DRINKS-------------------------
COCO_COLA = Checkbutton(f1aa,text="COCO-COLA \t\t",variable=var1,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=0,sticky=W)

PEPSI = Checkbutton(f1aa,text="PEPSI \t\t",variable=var2,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=1,sticky=W)

FANTA = Checkbutton(f1aa,text="FANTA \t\t",variable=var3,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=2,sticky=W)

SPRITE = Checkbutton(f1aa,text="SPRITE \t\t",variable=var4,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=3,sticky=W)

APPY = Checkbutton(f1aa,text="APPY \t\t",variable=var5,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=4,sticky=W)

#------------------------Cakes-----------------------------
BROWNIE = Checkbutton(f1ab,text="BROWNIE \t",variable=var6,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=0,sticky=W)

BLACKFOREST_CAKE = Checkbutton(f1ab,text="BLACKFOREST CAKE \t",variable=var7,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=1,sticky=W)

REDVELVET_CAKE = Checkbutton(f1ab,text="REDVELVET CAKE \t",variable=var8,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=2,sticky=W)

RAINBOW_CAKE = Checkbutton(f1ab,text="RAINBOW CAKE \t",variable=var9,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=3,sticky=W)

BUTTERSCOTCH_CAKE = Checkbutton(f1ab,text="BUTTERSCOTCH CAKE \t",variable=var10,onvalue=1,offvalue=0,font=('arial',18,'bold'),command=chkbutton_value).grid(row=4,sticky=W)

#---------------------Widgets for drinks--------------------
txtCOCO_COLA = Entry(f1aa,font=('arial',16,'bold'),bd=8,width=6,justify='left',textvariable=E_COCO_COLA,state=DISABLED)
...
#--------------------------Widgets for cakes----------------
txtBROWNIE = Entry(f1ab,font=('arial',16,'bold'),bd=8,width=6,justify='left',textvariable=E_BROWNIE,state=DISABLED)
txtBROWNIE.grid(row=0,column=1)
txtBLACKFOREST_CAKE = Entry(f1ab,font=('arial',16,'bold'),bd=8,width=6,justify='left',textvariable=E_BLACKFOREST_CAKE,state=DISABLED)
txtBLACKFOREST_CAKE.grid(row=1,column=1)
txtREDVELVET_CAKE = Entry(f1ab,font=('arial',16,'bold'),bd=8,width=6,justify='left',textvariable=E_REDVELVET_CAKE,state=DISABLED)
txtREDVELVET_CAKE.grid(row=2,column=1)
txtRAINBOW_CAKE = Entry(f1ab,font=('arial',16,'bold'),bd=8,width=6,justify='left',textvariable=E_RAINBOW_CAKE,state=DISABLED)
txtRAINBOW_CAKE.grid(row=3,column=1)
txtBUTTERSCOTCH_CAKE = Entry(f1ab,font=('arial',16,'bold'),bd=8,width=6,justify='left',textvariable=E_BUTTERSCOTCH_CAKE,state=DISABLED)
...
#-----------------------creating buttons--------------------------
btnTotal=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',11,'bold'),width=1,text="TOTAL",command=COI).grid(row=0,column=0)

btnReceipt=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',11,'bold'),width=3,text="RECEIPT",command=Rcpt).grid(row=0,column=1)

btnReset=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',11,'bold'),width=2,text="RESET",command=Reset).grid(row=0,column=2)

btnExit=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',11,'bold'),width=2,text="EXIT",command=qExit).grid(row=0,column=3)
