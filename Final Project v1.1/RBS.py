...
def indian():
    ...
    lbl2 = Label(frame, text="Indian Cuisine", pady=5, font=("Trebuchet MS", 20), bg="dark slate blue", fg="goldenrod",
                 padx=20)
    ...
    lbl4 = Label(frame, text="Price(₹)", fg="springgreen", pady=5, bg="dark slate blue", font=("Trebuchet MS", 18))
    ...
    price1 = Label(frame, text="120.00", pady=5, fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price1.grid(row=4, column=1)

    price2 = Label(frame, text="120.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price2.grid(row=5, column=1)

    price3 = Label(frame, text="140.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price3.grid(row=6, column=1)

    price4 = Label(frame, text="140.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price4.grid(row=7, column=1)

    price5 = Label(frame, text="140.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price5.grid(row=8, column=1)

    price6 = Label(frame, text="160.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    ...
    price7 = Label(frame, text="15.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price7.grid(row=11, column=1)

    price8 = Label(frame, text="25.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price8.grid(row=12, column=1)

    price9 = Label(frame, text="35.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
    price9.grid(row=13, column=1)

    price10 = Label(frame, text="35.00", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12))
...
def COI():
    ...
    POD = (ITEM1 * 120) + (ITEM2 * 120) + (ITEM3 * 140) + (ITEM4 * 140) + (ITEM5 * 140) + (ITEM6 * 160) + (ITEM7 * 15) + (ITEM8 * 25) + (ITEM9 * 35) + (ITEM10 * 35)
