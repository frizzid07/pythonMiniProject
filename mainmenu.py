...
class main:
    ...
    def CMS(self):
        ...
        # -----------------------DRINKS-------------------------
        COCO_COLA = Checkbutton(f1aa, text="COCO-COLA \t\t", variable=var1, onvalue=1, offvalue=0,
                                font=('arial', 18, 'bold'),
        ...
        txtPEPSI = Entry(f1aa, font=('arial', 16, 'bold'), bd=8, width=6, justify='left', textvariable=E_PEPSI,
                         state=DISABLED)
        txtPEPSI.grid(row=1, column=1)
        txtFANTA = Entry(f1aa, font=('arial', 16, 'bold'), bd=8, width=6, justify='left', textvariable=E_FANTA,
                         state=DISABLED)
        ...
        txtAPPY = Entry(f1aa, font=('arial', 16, 'bold'), bd=8, width=6, justify='left', textvariable=E_APPY,
                        state=DISABLED)
        ...
        txtRAINBOW_CAKE = Entry(f1ab, font=('arial', 16, 'bold'), bd=8, width=6, justify='left',
                                textvariable=E_RAINBOW_CAKE,
                                state=DISABLED)
    ...
    def widgets(self):
        ...
        self.head.pack()
        self.logf = Frame(self.master, padx=10, pady=10, bg="dark slate blue")
        # Label(self.logf,text = 'Username: ',font = ('',20),pady=5,padx=5).grid(sticky = W)
        # Label(self.logf, text="Welcome to...", font=("Helvetica", 15), bg="dark slate blue", fg="goldenrod", pady=20).grid(columnspan=3)
        Label(self.logf, text="LUXURY ROYALE", font=("Helvetica", 55), bg="dark slate blue", fg="springgreen",
              padx=20).grid(columnspan=3)
        Label(self.logf, text="Deluxe A/C Restaurant (Veg & Non-Veg)", font=("Helvetica", 15), bg="dark slate blue",
              fg="goldenrod", pady=10).grid(columnspan=3)
        Label(self.logf, text="Cashier Login", font=("Helvetica", 22), bg="dark slate blue", fg="springgreen",
              pady=25).grid(row=3, column=1, sticky=W)
        Label(self.logf, text="Cashier ID:", bg="dark slate blue", fg="goldenrod", font=("Helvetica", 15), padx=-20,
              pady=15).grid(row=4, column=0, sticky=E)
        Label(self.logf, text="Password:", bg="dark slate blue", fg="goldenrod", font=("Helvetica", 15), padx=-20,
              pady=25).grid(row=5, column=0, sticky=E)
        Entry(self.logf, textvariable=self.username, bd=5, font=('', 15)).grid(row=4, column=1, sticky=E)
        Entry(self.logf, show="*", textvariable=self.password, bd=5, font=('', 15)).grid(row=5, column=1, sticky=E)
        Button(self.logf, text="Login", font=("Helvetica", 12), relief=RAISED, bg="dark slate blue", fg="goldenrod",
               cursor="cross", padx=30, pady=5, activebackground="springgreen", command=self.login,
               activeforeground="goldenrod").grid(row=6, columnspan=3)
