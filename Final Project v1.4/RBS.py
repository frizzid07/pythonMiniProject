...
def italian():
    ...
    Label(frame, text="Mushroom-Sausage Rag", fg="springgreen", bg="dark slate blue", font=("Trebuchet MS", 12)).grid(row=4, sticky=W)
...
def mediterranean():
    ...
    llbl4 = Label(frame, text="Price()", fg="springgreen", pady=5, bg="dark slate blue", font=("Trebuchet MS", 18))
...
def Rcpt():
    ...
    if (var25.get() == 1):
        txtReceipt.insert(END, 'Fish ball soup: \t\t\t' + E_check25.get() + "\n")
    if (var26.get() == 1):
        txtReceipt.insert(END, 'Meat ball soup: \t\t\t' + E_check26.get() + "\n")
    if (var27.get() == 1):
        txtReceipt.insert(END, 'Egg & Vegetable soup: \t\t\t' + E_check27.get() + "\n")
    if (var28.get() == 1):
        txtReceipt.insert(END, 'Oyster soup:   \t\t\t' + E_check28.get() + "\n")

    if (varr1.get() == 1):
        txtReceipt.insert(END, 'Mushroom-Sausage Rag: \t\t\t' + E_checkk1.get() + "\n")
    if (varr2.get() == 1):
        txtReceipt.insert(END, 'Three-Cheese Lasagna: \t\t\t' + E_checkk2.get() + "\n")
    if (varr3.get() == 1):
        txtReceipt.insert(END, 'Grilled Fish: \t\t\t' + E_checkk3.get() + "\n")
    if (varr4.get() == 1):
        txtReceipt.insert(END, 'Beef Brasato: \t\t\t' + E_checkk4.get() + "\n")
    if (varr5.get() == 1):
        txtReceipt.insert(END, 'Risotto: \t\t\t' + E_checkk5.get() + "\n")
    if (varr6.get() == 1):
        txtReceipt.insert(END, 'Swordfish Sicilian-Style: \t\t\t' + E_checkk6.get() + "\n")
    if (varr7.get() == 1):
        txtReceipt.insert(END, 'Braised Chicken: \t\t\t' + E_checkk7.get() + "\n")
    if (varr8.get() == 1):
        txtReceipt.insert(END, 'Mushroom Lasagna: \t\t\t' + E_checkk8.get() + "\n")
    if (varr9.get() == 1):
        txtReceipt.insert(END, 'Italian Meatballs: \t\t\t' + E_checkk9.get() + "\n")
    if (varr10.get() == 1):
        txtReceipt.insert(END, 'Farro Soup: \t\t\t' + E_checkk10.get() + "\n")
    if (varr11.get() == 1):
        txtReceipt.insert(END, 'Pomodori Fritti: \t\t\t' + E_checkk11.get() + "\n")
    if (varr12.get() == 1):
        txtReceipt.insert(END, 'Insalata Mista: \t\t\t' + E_checkk12.get() + "\n")
    if (varr13.get() == 1):
        txtReceipt.insert(END, 'Insalata Verde: \t\t\t' + E_checkk13.get() + "\n")
    if (varr14.get() == 1):
        txtReceipt.insert(END, 'Insalata Di Pomodori: \t\t\t' + E_checkk14.get() + "\n")

    if (varr15.get() == 1):
        txtReceipt.insert(END, 'Chicken Medallions : \t\t\t' + E_checkk15.get() + "\n")
    if (varr16.get() == 1):
        txtReceipt.insert(END, 'Mediterranean Lettuce Wraps:' + E_checkk16.get() + "\n")
    if (varr17.get() == 1):
        txtReceipt.insert(END, 'Lemon Greek Chicken: \t\t\t' + E_checkk17.get() + "\n")
    if (varr18.get() == 1):
        txtReceipt.insert(END, 'Mediterranean Hummus Pizza:' + E_checkk18.get() + "\n")
    if (varr19.get() == 1):
        txtReceipt.insert(END, 'Red Pepper Pizza: \t\t\t' + E_checkk19.get() + "\n")
    if (varr20.get() == 1):
        txtReceipt.insert(END, 'Chicken & Orzo Soup:\t\t\t' + E_checkk20.get() + "\n")
    if (varr21.get() == 1):
        txtReceipt.insert(END, 'Greek Lemon Chicken Soup:\t\t\t' + E_checkk21.get() + "\n")
    if (varr22.get() == 1):
        txtReceipt.insert(END, 'Griddled chicken:\t\t\t' + E_checkk22.get() + "\n")
    if (varr23.get() == 1):
        txtReceipt.insert(END, 'chicken tray bake : \t\t\t' + E_checkk23.get() + "\n")
    if (varr24.get() == 1):
        txtReceipt.insert(END, 'Crunchy baked mussels : \t\t\t' + E_checkk24.get() + "\n")
    if (varr25.get() == 1):
        txtReceipt.insert(END, 'potato salad : \t\t\t' + E_checkk25.get() + "\n")
    if (varr26.get() == 1):
        txtReceipt.insert(END, 'summer salad : \t\t\t' + E_checkk26.get() + "\n")
    if (varr27.get() == 1):
        txtReceipt.insert(END, 'feta cheese toasts : \t\t\t' + E_checkk27.get() + "\n")
    if (varr28.get() == 1):
        txtReceipt.insert(END, 'mozzarella salad : \t\t' + E_checkk28.get() + "\n")
